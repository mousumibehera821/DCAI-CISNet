...
def metrics(im_dir, label_dir, use_GT_mean):
    ...
    for item in tqdm(sorted(glob.glob(im_dir))):
        ...
        gt_name = name.replace('low', 'normal')   # 🔥 FIX
        im2_path = os.path.join(label_dir, gt_name)
        print("GT path:", im2_path)   # debug (remove later)
...
if __name__ == '__main__':
    ...
    if mea.lol:
        ...
        label_dir = '/home/nitr/Desktop/Mousumi_Behera/Datasets/LOLv1/test/high/'
    if mea.lol_v2_real:
        im_dir = './output/LOLv2_real/*.png'
        label_dir = '/home/nitr/Desktop/Mousumi_Behera/Datasets/LOL-v2/Real/test/high/'
    if mea.lol_v2_syn:
        im_dir = './output/LOLv2_syn/*.png'
        label_dir = '/home/nitr/Desktop/Mousumi_Behera/Datasets/LOL-v2/Synthetic/test/high/'
    if mea.SICE_grad:
